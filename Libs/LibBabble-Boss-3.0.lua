...
local MINOR_VERSION = 90000 + tonumber(("$Rev: 282 $"):match("%d+"))
...
elseif GAME_LOCALE == "zhCN" then
	...
	["Deathbound Ward"] = "Deathbound Ward", -- Needs review
	["Deathbringer Saurfang"] = "死亡使者萨鲁法尔",
	["Death Knight Darkreaver"] = "死亡骑士达克雷尔",
	["Death Knight Understudy"] = "见习死亡骑士",
	["Deathspeaker High Priest"] = "Deathspeaker High Priest", -- Needs review
